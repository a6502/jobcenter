CREATE OR REPLACE FUNCTION jobcenter.do_raise_error_task(a_jobtask jobtask)
 RETURNS nextjobtask
 LANGUAGE plpgsql
...
BEGIN
	...
	IF NOT FOUND THEN
		...
		RAISE EXCEPTION 'do_raise_error_task called for non-raise_error-task %', a_jobtask.task_id;
	END IF;
	...
	RETURN do_raise_error(a_jobtask, v_msg);
END;$function$
